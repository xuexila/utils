...
func ModelDelete[T any](w http.ResponseWriter, r *http.Request, tx *gorm.DB, c userDb.QueryConfig) {
...
func ModelDeleteByUpdate[T any](w http.ResponseWriter, r *http.Request, tx *gorm.DB, c userDb.QueryConfig) {
	if !httpServer.CheckReqPost(w, r) {
		return
	}
