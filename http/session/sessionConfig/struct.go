...
type Dialector interface {
	Get(w http.ResponseWriter, r *http.Request, name string) (string, error)                             // 获取session
	GetUp(w http.ResponseWriter, r *http.Request, name string) (string, error)                           // 获取并刷新
	Flashes(w http.ResponseWriter, r *http.Request, name string) (string, error)                         // 获取session然后销毁
...
type Session struct {
	...
	Values     string              `json:"values" gorm:"type:text;comment:session数据"`                       // session 数据
